...
export default class Video {
  constructor({ ...arg }) {
    ...
    this.buffered_range_x = this.control
      .querySelector(".buffered")
      .querySelector(".range_x");
    this.played_range_x = this.control
      .querySelector(".played")
      .querySelector(".range_x");
    this.volume_btn = this.control
      .querySelector(".volume_time")
      .querySelector(".volume_btn");
    this.volume_line_range_x = this.control
      .querySelector(".volume_time")
      .querySelector(".range_x");
    // svg anime
  ...
  full_screen_change(el) {
    if (document.fullscreenElement !== null) {
      el.fullscreen_svg_0.setAttribute(
        "d",
        "m 14,14 -4,0 0,2 6,0 0,-6 -2,0 0,4 0,0 z"
      );
      el.fullscreen_svg_1.setAttribute(
        "d",
        "m 22,14 0,-4 -2,0 0,6 6,0 0,-2 -4,0 0,0 z"
      );
      el.fullscreen_svg_2.setAttribute(
        "d",
        "m 20,26 2,0 0,-4 4,0 0,-2 -6,0 0,6 0,0 z"
      );
      el.fullscreen_svg_3.setAttribute(
        "d",
